...
public class PopViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (keyValueBean.getValue().equals(selectorText)) {
            ...
            ColorStateList csl = context.getResources().getColorStateList(R.color.home_list_bg_blue);
            view.setTextColor(csl);
        } else {
            view.setBackgroundResource(normalResId);
            ColorStateList csl = context.getResources().getColorStateList(R.color.text_color);
            view.setTextColor(csl);
        }
