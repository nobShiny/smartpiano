package com.lsj.smartpiano.common.customui;
...
public class ExpandPopTabView extends LinearLayout implements PopupWindow.OnDismissListener {
    private ArrayList<RelativeLayout> mViewLists = new ArrayList<>();
    ...
    public void addItemToExpandTab(String tabTitle, ViewGroup tabItemView) {
        ...
        if(mPopViewBackgroundColor != -1){
            ...
            popContainerView.setBackgroundColor(Color.parseColor("#00000000"));
        }
        RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT,RelativeLayout.LayoutParams.WRAP_CONTENT );//(int) (mDisplayHeight * 0.4)
