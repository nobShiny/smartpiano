package com.lsj.smartpiano.module.video.customui;
...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mSwipeRefreshLayout.setColorSchemeResources(R.color.refresh_state_start, R.color.refresh_state_wait, R.color.refresh_state_end);
...
//        mRecyclerView.addItemDecoration(null);//new DividerGridItemDecoration(mContext)
